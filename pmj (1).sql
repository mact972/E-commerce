...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 24 Mars 2015 à 09:51
...
CREATE TABLE IF NOT EXISTS `contenu` (
  `id_Contenu` int(3) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `livraison` (
  `id_Livraison` int(3) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `produit` (
  `id_Produit` int(3) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `relai` (
  `id_Relai` int(3) NOT NULL DEFAULT '0',

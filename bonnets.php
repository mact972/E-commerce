...
<html lang="fr" class="no-js">
	...
	<body class="back">
		...
		<main>
			...
			<div class='bordero'><p><i><a href="accueil.php">Accueil</a></i> > <a href="categorie.php">Catégorie</a> > <a href="bonnets.php">Chapeau Bob</a></p></div>
            <hr class='h'>
			<div class="filtre"><br><p class="fi"><b>CATALOGUE</b></p>
				...
				<div class="Mark">
					...
					<?php
						...
						try{
								$req = 'select DISTINCT Marque from contenu c, produit p where c.id_Produit = p.id_Produit and type="Chapeau Bob"';
				...
				<div class="coul">
					...
					<?php
						...
						try{
								$req = 'select DISTINCT couleur from contenu c, produit p where c.id_Produit = p.id_Produit and type="Chapeau Bob"';
								$resultat = $bdd->query($req);
				...
				<div class="Tail">
					...
					<?php
						...
						try{
								$req = 'select DISTINCT taille from contenu c, produit p where c.id_Produit = p.id_Produit and type="Chapeau Bob"';
								$resultat = $bdd->query($req);
			...
			<div class="prod">
				...
				<?php
						...
						try{
								$req = "select * from contenu c, produit p where c.id_Produit = p.id_Produit and type='Chapeau Bob'";
								$resultat = $bdd->query($req);
